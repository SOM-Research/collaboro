...
/**
 * This is the item provider adapter for a {@link fr.inria.atlanmod.collaboro.history.SyntaxElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SyntaxElementItemProvider
	...
	public String getText(Object object) {
		String label = ((SyntaxElement)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_SyntaxElement_type") :
			getString("_UI_SyntaxElement_type") + " " + label;
	}
