...
/**
 * This is the item provider adapter for a {@link fr.inria.atlanmod.collaboro.history.Version} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VersionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HistoryPackage.Literals.VERSION__PREVIOUS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HistoryPackage.Literals.VERSION__PROPOSALS);
		}
	...
	public String getText(Object object) {
		String label = ((Version)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HistoryPackage.Literals.VERSION__PROPOSALS,
				 HistoryFactory.eINSTANCE.createProposal()));
	}
