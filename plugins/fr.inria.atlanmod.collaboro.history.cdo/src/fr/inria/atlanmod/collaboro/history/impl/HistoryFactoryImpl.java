...
public class HistoryFactoryImpl extends EFactoryImpl implements HistoryFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case HistoryPackage.VERSION_HISTORY: return (EObject)createVersionHistory();
			case HistoryPackage.USER: return (EObject)createUser();
			case HistoryPackage.VERSION: return (EObject)createVersion();
			case HistoryPackage.VOTE: return (EObject)createVote();
			case HistoryPackage.COLLABORATION: return (EObject)createCollaboration();
			case HistoryPackage.PROPOSAL: return (EObject)createProposal();
			case HistoryPackage.SOLUTION: return (EObject)createSolution();
			case HistoryPackage.COMMENT: return (EObject)createComment();
			case HistoryPackage.ADD: return (EObject)createAdd();
			case HistoryPackage.UPDATE: return (EObject)createUpdate();
			case HistoryPackage.DELETE: return (EObject)createDelete();
			case HistoryPackage.EXISTING_ABSTRACT_SYNTAX_ELEMENT: return (EObject)createExistingAbstractSyntaxElement();
			case HistoryPackage.NEW_ABSTRACT_SYNTAX_ELEMENT: return (EObject)createNewAbstractSyntaxElement();
			case HistoryPackage.CONCRETE_SYNTAX_ELEMENT: return (EObject)createConcreteSyntaxElement();
			case HistoryPackage.PRIORITY: return (EObject)createPriority();
			case HistoryPackage.TAG_BASED: return (EObject)createTagBased();
			case HistoryPackage.TAG: return (EObject)createTag();
			default:
