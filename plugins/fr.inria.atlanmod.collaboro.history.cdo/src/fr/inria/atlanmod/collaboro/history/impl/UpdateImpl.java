...
public class UpdateImpl extends ModelChangeImpl implements Update {
	...
	public SyntaxElement getSource() {
		return (SyntaxElement)eDynamicGet(HistoryPackage.UPDATE__SOURCE, HistoryPackage.Literals.UPDATE__SOURCE, true, true);
	}
	...
	public NotificationChain basicSetSource(SyntaxElement newSource, NotificationChain msgs) {
		msgs = eDynamicInverseAdd((InternalEObject)newSource, HistoryPackage.UPDATE__SOURCE, msgs);
		return msgs;
	}
	...
	public void setSource(SyntaxElement newSource) {
		eDynamicSet(HistoryPackage.UPDATE__SOURCE, HistoryPackage.Literals.UPDATE__SOURCE, newSource);
	}
