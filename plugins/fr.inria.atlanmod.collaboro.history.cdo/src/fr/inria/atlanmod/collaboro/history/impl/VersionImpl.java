...
public class VersionImpl extends IdElementImpl implements Version {
	...
	public EList<Proposal> getProposals() {
		return (EList<Proposal>)eDynamicGet(HistoryPackage.VERSION__PROPOSALS, HistoryPackage.Literals.VERSION__PROPOSALS, true, true);
	}
	...
	public EList<Version> getPrevious() {
		return (EList<Version>)eDynamicGet(HistoryPackage.VERSION__PREVIOUS, HistoryPackage.Literals.VERSION__PREVIOUS, true, true);
	}
