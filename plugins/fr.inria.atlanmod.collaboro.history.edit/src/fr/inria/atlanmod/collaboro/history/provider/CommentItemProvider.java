...
/**
 * This is the item provider adapter for a {@link fr.inria.atlanmod.collaboro.history.Comment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Comment_included_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Comment_included_feature", "_UI_Comment_type"),
				 HistoryPackage.Literals.COMMENT__INCLUDED,
				 true,
				 false,
				 false,
