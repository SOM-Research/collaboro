...
/**
 * This is the item provider adapter for a {@link fr.inria.atlanmod.collaboro.history.History} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HistoryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_History_language_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_History_language_feature", "_UI_History_type"),
				 HistoryPackage.Literals.HISTORY__LANGUAGE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HistoryPackage.Literals.HISTORY__USERS);
			childrenFeatures.add(HistoryPackage.Literals.HISTORY__HISTORIES);
		}
	...
	public String getText(Object object) {
		String label = ((History)object).getLanguage();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HistoryPackage.Literals.HISTORY__USERS,
				 HistoryFactory.eINSTANCE.createUser()));

		newChildDescriptors.add
			(createChildParameter
				(HistoryPackage.Literals.HISTORY__HISTORIES,
				 HistoryFactory.eINSTANCE.createVersionHistory()));
	}
