...
/**
 * This is the item provider adapter for a {@link fr.inria.atlanmod.collaboro.history.Proposal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProposalItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Proposal_selected_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Proposal_selected_feature", "_UI_Proposal_type"),
				 HistoryPackage.Literals.PROPOSAL__SELECTED,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAcceptedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Proposal_accepted_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Proposal_accepted_feature", "_UI_Proposal_type"),
				 HistoryPackage.Literals.PROPOSAL__ACCEPTED,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HistoryPackage.Literals.PROPOSAL__SOLS);
			childrenFeatures.add(HistoryPackage.Literals.PROPOSAL__META);
		}
	...
	public String getText(Object object) {
		String label = ((Proposal)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HistoryPackage.Literals.PROPOSAL__SOLS,
				 HistoryFactory.eINSTANCE.createSolution()));

		newChildDescriptors.add
			(createChildParameter
				(HistoryPackage.Literals.PROPOSAL__META,
				 HistoryFactory.eINSTANCE.createPriority()));

		newChildDescriptors.add
			(createChildParameter
				(HistoryPackage.Literals.PROPOSAL__META,
				 HistoryFactory.eINSTANCE.createTagBased()));
	}
