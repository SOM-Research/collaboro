...
/**
 * This is the item provider adapter for a {@link fr.inria.atlanmod.collaboro.history.Solution} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SolutionItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HistoryPackage.Literals.SOLUTION__CHANGES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HistoryPackage.Literals.SOLUTION__CHANGES,
				 HistoryFactory.eINSTANCE.createAdd()));

		newChildDescriptors.add
			(createChildParameter
				(HistoryPackage.Literals.SOLUTION__CHANGES,
				 HistoryFactory.eINSTANCE.createUpdate()));

		newChildDescriptors.add
			(createChildParameter
				(HistoryPackage.Literals.SOLUTION__CHANGES,
				 HistoryFactory.eINSTANCE.createDelete()));
	}
