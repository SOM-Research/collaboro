...
public class HistoryImpl extends EObjectImpl implements History {
	...
	public EList<User> getUsers() {
		if (users == null) {
			users = new EObjectContainmentEList<User>(User.class, this, HistoryPackage.HISTORY__USERS);
		}
		return users;
	}
	...
	public void setLanguage(String newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HistoryPackage.HISTORY__LANGUAGE, oldLanguage, language));
	}
