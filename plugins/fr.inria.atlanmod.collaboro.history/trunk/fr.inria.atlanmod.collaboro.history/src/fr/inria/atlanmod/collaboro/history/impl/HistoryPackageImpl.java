...
public class HistoryPackageImpl extends EPackageImpl implements HistoryPackage {
	 ...
	 * @generated
	 */
	public EAttribute getModelChange_Target() {
		return (EAttribute)modelChangeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getModelChange_ReferredElement() {
		return (EAttribute)modelChangeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getUpdate_Source() {
	...
	public void createPackageContents() {
		...
		createEAttribute(modelChangeEClass, MODEL_CHANGE__TARGET);
		createEAttribute(modelChangeEClass, MODEL_CHANGE__REFERRED_ELEMENT);
		createEReference(modelChangeEClass, MODEL_CHANGE__SOLUTION);

		addEClass = createEClass(ADD);

		updateEClass = createEClass(UPDATE);
		createEAttribute(updateEClass, UPDATE__SOURCE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getModelChange_Target(), ecorePackage.getEString(), "target", null, 0, 1, ModelChange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getModelChange_ReferredElement(), ecorePackage.getEString(), "referredElement", null, 0, 1, ModelChange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getUpdate_Source(), ecorePackage.getEString(), "source", null, 0, 1, Update.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
