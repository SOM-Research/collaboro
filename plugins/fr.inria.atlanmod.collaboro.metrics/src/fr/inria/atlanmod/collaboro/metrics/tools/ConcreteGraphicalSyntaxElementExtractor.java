...
public class ConcreteGraphicalSyntaxElementExtractor extends ConcreteSyntaxElementExtractor{
	
	private Definition concreteSyntaxModel;
	private List<Symbol> symbols;
	
	public ConcreteGraphicalSyntaxElementExtractor(Definition concreteSyntaxModel) {
		this.concreteSyntaxModel = concreteSyntaxModel;
		this.symbols = new ArrayList<Symbol>();
	}

	public List<Symbol> discoverConcreteSymbols() {
