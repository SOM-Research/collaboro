...
public class ConcreteTextualSyntaxElementExtractor extends ConcreteSyntaxElementExtractor {

	private Definition concreteSyntaxModel;
	private List<Symbol> symbols;
	
	public ConcreteTextualSyntaxElementExtractor(Definition concreteSyntaxModel) {
