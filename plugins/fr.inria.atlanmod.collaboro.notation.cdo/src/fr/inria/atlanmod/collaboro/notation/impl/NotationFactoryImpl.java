...
public class NotationFactoryImpl extends EFactoryImpl implements NotationFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case NotationPackage.RECTANGLE: return (EObject)createRectangle();
			case NotationPackage.LINE: return (EObject)createLine();
			case NotationPackage.LABEL: return (EObject)createLabel();
			case NotationPackage.TEXTUAL_ELEMENT: return (EObject)createTextualElement();
			case NotationPackage.TOKEN: return (EObject)createToken();
			case NotationPackage.KEYWORD: return (EObject)createKeyword();
			case NotationPackage.ATTRIBUTE_VALUE: return (EObject)createAttributeValue();
			case NotationPackage.REFERENCE_VALUE: return (EObject)createReferenceValue();
			case NotationPackage.SYNTAX_OF: return (EObject)createSyntaxOf();
			case NotationPackage.COMPOSITE: return (EObject)createComposite();
			case NotationPackage.DEFINITION: return (EObject)createDefinition();
			default:
