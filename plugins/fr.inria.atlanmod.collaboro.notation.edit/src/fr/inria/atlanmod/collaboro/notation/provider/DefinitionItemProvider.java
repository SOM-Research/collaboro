...
/**
 * This is the item provider adapter for a {@link fr.inria.atlanmod.collaboro.notation.Definition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DefinitionItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NotationPackage.Literals.DEFINITION__ELEMENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Definition.class)) {
			case NotationPackage.DEFINITION__ELEMENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NotationPackage.Literals.DEFINITION__ELEMENTS,
				 NotationFactory.eINSTANCE.createLine()));

		newChildDescriptors.add
			(createChildParameter
				(NotationPackage.Literals.DEFINITION__ELEMENTS,
				 NotationFactory.eINSTANCE.createLabel()));

		newChildDescriptors.add
			(createChildParameter
				(NotationPackage.Literals.DEFINITION__ELEMENTS,
				 NotationFactory.eINSTANCE.createTextualElement()));

		newChildDescriptors.add
			(createChildParameter
				(NotationPackage.Literals.DEFINITION__ELEMENTS,
				 NotationFactory.eINSTANCE.createToken()));

		newChildDescriptors.add
			(createChildParameter
				(NotationPackage.Literals.DEFINITION__ELEMENTS,
				 NotationFactory.eINSTANCE.createKeyword()));

		newChildDescriptors.add
			(createChildParameter
				(NotationPackage.Literals.DEFINITION__ELEMENTS,
				 NotationFactory.eINSTANCE.createAttributeValue()));

		newChildDescriptors.add
			(createChildParameter
				(NotationPackage.Literals.DEFINITION__ELEMENTS,
				 NotationFactory.eINSTANCE.createReferenceValue()));

		newChildDescriptors.add
			(createChildParameter
				(NotationPackage.Literals.DEFINITION__ELEMENTS,
				 NotationFactory.eINSTANCE.createSyntaxOf()));

		newChildDescriptors.add
			(createChildParameter
				(NotationPackage.Literals.DEFINITION__ELEMENTS,
				 NotationFactory.eINSTANCE.createComposite()));
	}
