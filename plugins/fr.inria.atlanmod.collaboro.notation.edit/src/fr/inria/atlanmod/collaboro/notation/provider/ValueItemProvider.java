...
/**
 * This is the item provider adapter for a {@link fr.inria.atlanmod.collaboro.notation.Value} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Value_separator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Value_separator_feature", "_UI_Value_type"),
				 NotationPackage.Literals.VALUE__SEPARATOR,
				 true,
				 false,
				 false,
	...
	protected void addAttributePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Value_attribute_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Value_attribute_feature", "_UI_Value_type"),
				 NotationPackage.Literals.VALUE__ATTRIBUTE,
				 true,
				 false,
				 true,
				 null,
