 ...
 * <ul>
 *   <li>{@link fr.inria.atlanmod.collaboro.notation.impl.CompositeImpl#getSubElements <em>Sub Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CompositeImpl extends NotationElementImpl implements Composite {
	/**
	 ...
	 * @ordered
	 */
	protected EList<NotationElement> subElements;
	 ...
	 * @generated
	 */
	public EList<NotationElement> getSubElements() {
		if (subElements == null) {
			subElements = new EObjectContainmentEList<NotationElement>(NotationElement.class, this, NotationPackage.COMPOSITE__SUB_ELEMENTS);
		}
		return subElements;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case NotationPackage.COMPOSITE__SUB_ELEMENTS:
				...
				getSubElements().addAll((Collection<? extends NotationElement>)newValue);
				return;
		}
