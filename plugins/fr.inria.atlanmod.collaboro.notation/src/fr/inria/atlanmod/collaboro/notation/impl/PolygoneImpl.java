 ...
 * <ul>
 *   <li>{@link fr.inria.atlanmod.collaboro.notation.impl.PolygoneImpl#getLines <em>Lines</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PolygoneImpl extends FigureImpl implements Polygone {
	/**
	...
	protected EClass eStaticClass() {
		return NotationPackage.Literals.POLYGONE;
	}
	...
	public EList<Line> getLines() {
		if (lines == null) {
			lines = new EObjectContainmentEList<Line>(Line.class, this, NotationPackage.POLYGONE__LINES);
		}
		return lines;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NotationPackage.POLYGONE__LINES:
