...
public class ReferenceValueImpl extends ValueImpl implements ReferenceValue {
		...
		if (reference != null && reference.eIsProxy()) {
			...
			if (reference != oldReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, NotationPackage.REFERENCE_VALUE__REFERENCE, oldReference, reference));
			}
		}
		return reference;
	}
	...
	public void setReference(EReference newReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.REFERENCE_VALUE__REFERENCE, oldReference, reference));
	}
