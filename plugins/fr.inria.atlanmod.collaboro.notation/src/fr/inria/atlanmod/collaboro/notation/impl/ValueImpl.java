...
public abstract class ValueImpl extends TextualElementImpl implements Value {
	...
	public void setSeparator(String newSeparator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.VALUE__SEPARATOR, oldSeparator, separator));
	}
	...
	public EAttribute getAttribute() {
		if (attribute != null && attribute.eIsProxy()) {
			...
			if (attribute != oldAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, NotationPackage.VALUE__ATTRIBUTE, oldAttribute, attribute));
			}
		}
		return attribute;
	}
	...
	public void setAttribute(EAttribute newAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.VALUE__ATTRIBUTE, oldAttribute, attribute));
	}
